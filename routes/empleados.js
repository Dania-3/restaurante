 ...
 * tags:
 *   - name: Empleados
 *     description: Operaciones relacionadas con la gestión de los empleados
 */
 ...
 *                 fk_tipo:
 *                   type: string
 *                   description: Tipo de usuario (puesto)
 *                 nombre:
 *                   type: string
 ...
 *       500:
 *         description: Error al obtener los datos del empleado
 */
 ...
 * /api/empleadosTabla:
 *   get:
 *     summary: Obtener todos los empleados para mostrar en tabla
 *     tags: [Empleados]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *                 empleadoId:
 *                   type: integer
 *                   description: ID del nuevo empleado creado
 *       400:
 *         description: Faltan datos para agregar el empleado
 *       500:
 ...
 *       400:
 *         description: Faltan datos para actualizar el empleado
 *       404:
 *         description: Empleado no encontrado
 *       500:
 ...
 * /api/empleados/{id}:
 *   delete:
 *     summary: Eliminar un empleado por ID (cambiar estado a inactivo)
 *     tags: [Empleados]
 *     security:
 *       - bearerAuth: []
 *     parameters:
